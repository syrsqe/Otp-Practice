...
var currentTarget, currentSchedule;
var schedules = [];
if(schedules.length === 0){
  schedules.push(document.querySelector(".carousel-item.active"));
}
...
if (document.addEventListener) { // IE >= 9; other browsers
  schedules.forEach(function(shedule){
...
function getTableContent() {
  ...
  for (let i = 0; i < rowObjects.length; i++) {
    ...
    let form = currentSchedule.querySelector(".table-submit-form");
  ...
  currentSchedule.querySelector(".table-submit-form").submit();
...
function addSchedule() {
  ...
  var newTable = document.querySelector(".carousel-item.active").cloneNode(true);
    if (newTable === null) {
